...
- Get the comments for a post  | GET /post/comments
- Create a comment for a post  | POST /post/{postId}/comments
...
- Remove a like for a post     | DELETE /posts/{postId}/likes/{likeId}
- Get all the posts of a user  | GET /users/{userId}/posts
- Submit a search on posts     | GET /posts?query=searchTerm
